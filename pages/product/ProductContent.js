              ...
              <div className="product_content_container d-flex flex-lg-row flex-column align-items-start justify-content-start">
                  ...
                  <div className="product_content_inner">
                    <div className="product_image_row d-flex flex-md-row flex-column align-items-md-end align-items-start justify-content-start">
                      <div className="product_image_1 product_image">
                        <img src="/static/images/product_single_1.jpg" alt />
                      </div>
                      <div className="product_image_2 product_image">
                        <img src="/static/images/product_single_2.jpg" alt />
                      </div>
                    </div>
                    <div className="product_image_row">
                      <div className="product_image_3 product_image">
                        <img src="/static/images/product_single_3.jpg" alt />
                      </div>
                    </div>
                    <div className="product_image_row d-flex flex-md-row flex-column align-items-start justify-content-start">
                      <div className="product_image_4 product_image">
                        <img src="/static/images/product_single_4.jpg" alt />
                      </div>
                      <div className="product_image_5 product_image">
                        <img src="/static/images/product_single_5.jpg" alt />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="product_sidebar order-lg-2 order-1">
                  <form action="#" id="product_form" className="product_form">
                    ...
                    <button className="cart_button trans_200">
                      add to cart
                    </button>
                    <div className="similar_products_button trans_200">
                      <a href="categories.html">see similar products</a>
                    </div>
                  </form>
